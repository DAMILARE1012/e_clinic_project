...
<html lang="en" dir="ltr">
  ...
  <title>Flag Icons - Sleek Admin Dashboard Template</title>
									...
									<div class="card-body">
										<div class="text-center row">
											<div class="mb-5 text-left col-12">For using the flags inline with text add the classes
												...
												<code>.flag-icon-xx</code> (where xx is the ISO 3166-1-alpha-2 code of a country) to an empty span. If you want to
												have a squared version flag
												then add the class flag-icon-squared as well.</div>
											<div class="mb-5 col-3 col-sm-2">
