            ...
            <li class="breadcrumb-item" aria-current="page">alert</li>
							...
							<div class="card card-default">
								...
								<div class="card-body">
									<div class="row">
										<div class="col-12">
											<p class="mb-5">Alerts provide contextual feedback messages for typical user actions with the handful of available and flexible alert messages. Read bootstrap documentaion for <a href="https://getbootstrap.com/docs/4.1/components/alerts/" target="_blank"> more details.</a></p> 
										</div>
										<div class="col-lg-6">
									...
									<div class="row">
										<div class="col-12">
											<p class="mb-5">Alerts are available for any length of text, as well as an optional dismiss button. For proper
												...
												For inline dismissal, use the <a href="https://getbootstrap.com/docs/4.1/components/alerts/#dismissing" target="_blank">alerts jQuery plugin.</a></p>
										</div>
										<div class="col-lg-6">
											<label for="primary">primary alerts</label>
