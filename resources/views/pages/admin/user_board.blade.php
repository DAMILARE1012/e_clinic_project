...
<html lang="en" dir="ltr">
  ...
  <title>Sidebar With Footer - Sleek Admin Dashboard Template</title>
  ...
  <body class="sidebar-fixed sidebar-dark header-fixed header-light right-sidebar-out" id="body">
    <script>
                    ...
                    <ul  class="collapse show"  id="documentation"
                      ...
                      <div class="sub-menu">
                        ...
                        <li  class="has-sub active expand" >
                          ...
                          <ul  class="collapse show"  id="sidebar-navs">
                            <div class="sub-menu">
										...
										<div class="card-body">
											<blockquote class="blockquote">
												<p class="mb-0">Add class
													...
													<code>&lt;body id="body" class="right-sidebar-out"&gt;</code> like below.</p>
											</blockquote>
