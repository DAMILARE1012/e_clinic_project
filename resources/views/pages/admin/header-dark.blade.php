...
<html lang="en" dir="ltr">
    <head>
        ...
        <title>Header Dark - Sleek Admin Dashboard Template</title>
        ...
        <link
            href="assets/plugins/flag-icons/css/flag-icon.min.css"
            rel="stylesheet"
        />
        <link
                    ...
                    <div class="sidebar-scrollbar">
                        ...
                        <ul class="nav sidebar-inner" id="sidebar-menu">
                            ...
                            <li class="has-sub">
                                ...
                                >
                                    <i
                                        class="mdi mdi-folder-multiple-outline"
                                    ></i>
                                        ...
                                        <li class="has-sub">
                                            ...
                                            >
                                                <div class="sub-menu">
                                                    ...
                                                    <li>
                                                        <a
                                                            href="sidebar-without-footer.html"
                                                            >Sidebar Without
                                                            Footer</a
                                                        >
                                                    </li>
                                    ...
                                    >
                                        ...
                                        <li>
                                            <a href="#">
                                                ...
                                                New user registered
                                                <span
                                                    class="font-size-12 d-inline-block float-right"
                                                    ><i
                                        ...
                                        <li>
                                            <a href="#">
                                                <i
                                                    class="mdi mdi-chart-areaspline"
                                                ></i>
                                        ...
                                        <li>
                                            <a href="#">
                                                <i
                                                    class="mdi mdi-account-supervisor"
                                                ></i>
                                                New client
                                                <span
                                                    class="font-size-12 d-inline-block float-right"
                                        ...
                                        <li>
                                            <a href="#">
                                                <i
                                                    class="mdi mdi-server-network-off"
                                                ></i>
                                                Server overloaded
                                                <span
                                                    class="font-size-12 d-inline-block float-right"
                                    ...
                                    <div class="card-body">
                                        <blockquote class="blockquote">
                                            <p class="mb-0">
                                                ...
                                                >
                                                and remove class
                                                <code>header-light</code> if it
                                                was added before.
                                            </p>
                                        </blockquote>
                                        <pre
                                            class="mt-4"
                                        ><code>&lt;body id="body" class="header-dark"&gt;</code></pre>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <footer class="footer mt-auto">
                    <div class="copyright bg-white">
                        <p>
                            ...
                            Sleek Dashboard Bootstrap Template by
                            <a
                                class="text-primary"
