...
<html lang="en" dir="ltr">
  ...
  <title>Collapse - Sleek Admin Dashboard Template</title>
      ...
      <div class="page-wrapper">
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb p-0">
            ...
            <li class="breadcrumb-item" aria-current="page">collapse</li>
          </ol>
        </nav>
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="card card-default">
										...
										<div class="card-body">
											<p class="mb-5">Using the card component, you can extend the default collapse behavior to create an accordion. Read bootstrap documentaion for <a href="https://getbootstrap.com/docs/4.1/components/collapse/#accordion-example" target="_blank">
												more details.</a></p>
								...
								<div class="col-lg-6">
									<div class="card card-default">
										<div class="card-header card-header-border-bottom">
											<h2>Accordion Shadow</h2>
										</div>
										<div class="card-body">
											<p class="mb-5"> For accordion shadow add class <code> .accordion-shadow </code> to <code> &lt;div id="accordion2" class="accordion"&gt; </code> </p>
								...
								<div class="col-lg-6">
									<div class="card card-default">
										<div class="card-header card-header-border-bottom">
											<h2>Accordion Bordered</h2>
										</div>
										<div class="card-body">
											<p class="mb-5"> For accordion shadow add class <code> .accordion-bordered </code> to <code> &lt;div id="accordion3" class="accordion"&gt; </code>
											</p>
								...
								<div class="col-lg-6">
									<div class="card card-default">
										<div class="card-header card-header-border-bottom">
											<h2>Accordion Header bottom border</h2>
										</div>
										<div class="card-body">
											<p class="mb-5"> For accordion shadow add class <code> .accordion-header-border-bottom </code> to <code> &lt;div id="accordion4" class="accordion"&gt; </code>
											</p>
											<div id="accordion4" class="accordion accordion-header-border-bottom ">
												...
												<div class="card">
													...
													<div id="collapse5" class="collapse" aria-labelledby="heading5" data-parent="#accordion4">
														<div class="card-body">
															Lorem ipsum dolor sit amet, consectetur adipisicing elit sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.enim
															ad minim veniam quis nostrud exer citation ullamco laboris nisi ut aliquip ex ea commodo consequat duis aute.
														</div>
												...
												<div class="card">
													...
													<div id="collapse6" class="collapse" aria-labelledby="heading6" data-parent="#accordion4">
														<div class="card-body">
															Lorem ipsum dolor sit amet, consectetur adipisicing elit sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.enim
															ad minim veniam quis nostrud exer citation ullamco laboris nisi ut aliquip ex ea commodo consequat duis aute.
														</div>
