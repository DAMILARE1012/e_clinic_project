...
<html lang="en" dir="ltr">
  ...
  <title>Header Light - Sleek Admin Dashboard Template</title>
                    ...
                    <ul  class="collapse show"  id="documentation"
                      ...
                      <div class="sub-menu">
                        ...
                        <li  class="has-sub active expand" >
                          ...
                          <ul  class="collapse show"  id="headers">
                            <div class="sub-menu">
										...
										<div class="card-body">
											<blockquote class="blockquote">
												<p class="mb-0">Add class
													<code>header-light</code> to
													<code>&lt;body id="body"&gt;</code> and remove class <code>header-dark</code> if it was added before.</p>
											</blockquote>
											<pre class="mt-4"><code>&lt;body id="body" class="header-light"&gt;</code></pre>
										</div>
									</div>
								</div>
							</div>
