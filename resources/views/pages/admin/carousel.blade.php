...
<html lang="en" dir="ltr">
  ...
  <title>Carousel - Sleek Admin Dashboard Template</title>
							...
							<div class="row">
								...
								<div class="col-lg-6">
									<div class="card card-default">
										...
										<div class="card-body">
											<p class="mb-5">A slideshow component for cycling through elements—images or slides of text—like a carousel. Read bootstrap documentaion for <a href="https://getbootstrap.com/docs/4.1/components/carousel/" target="_blank">
												more details.</a> </p>
											<div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
												<div class="carousel-inner">
													<div class="carousel-item active">
														<img class="d-block w-100" src="assets/img/elements/slide1.jpg" alt="First slide">
													</div>
													<div class="carousel-item">
														<img class="d-block w-100" src="assets/img/elements/slide2.jpg" alt="Second slide">
													</div>
												</div>
											</div>
										</div>
								...
								<div class="col-lg-6">
									<div class="card card-default">
										...
										<div class="card-body">
											<p class="mb-5">Adding in the previous and next controls. Read bootstrap documentaion for <a href="https://getbootstrap.com/docs/4.1/components/carousel/#with-controls" target="_blank"> more details.</a> </p>
											<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
												<div class="carousel-inner">
													<div class="carousel-item active">
														<img class="d-block w-100" src="assets/img/elements/slide2.jpg" alt="First slide">
													</div>
													<div class="carousel-item">
														<img class="d-block w-100" src="assets/img/elements/slide1.jpg" alt="Second slide">
													</div>
												</div>
								...
								<div class="col-lg-6">
									<div class="card card-default">
										...
										<div class="card-body">
											<p class="mb-5">You can also add the indicators to the carousel, alongside the controls, too. Read bootstrap documentaion for <a href="https://getbootstrap.com/docs/4.1/components/carousel/#with-indicators"
											...
											<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
												...
												<div class="carousel-inner">
													<div class="carousel-item active">
														<img class="d-block w-100" src="assets/img/elements/slide3.jpg" alt="First slide">
													</div>
													<div class="carousel-item">
														<img class="d-block w-100" src="assets/img/elements/slide4.jpg" alt="Second slide">
													</div>
												</div>
								...
								<div class="col-lg-6">
									<div class="card card-default">
										...
										<div class="card-body">
											<p class="mb-5">Add captions to your slides easily with the .carousel-caption element within any .carousel-item. Read bootstrap documentaion for <a href="https://getbootstrap.com/docs/4.1/components/carousel/#with-captions" target="_blank"> more details.</a> </p>
											<div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
												...
												<div class="carousel-inner">
													<div class="carousel-item bg-gradient-dark active">
														<img class="d-block w-100" src="assets/img/elements/slide4.jpg" alt="First slide">
														<div class="carousel-caption d-none d-md-block">
															<h5>First Title Goes Here</h5>
															<p>Praesent commodo cursus magna vel scelerisque</p>
														</div>
													</div>
													<div class="carousel-item bg-gradient-dark">
														<img class="d-block w-100" src="assets/img/elements/slide3.jpg" alt="Second slide">
														<div class="carousel-caption d-none d-md-block">
															<h5>Second Title Goes Here</h5>
															<p>Praesent commodo cursus magna vel scelerisque</p>
														</div>
													</div>
												</div>
										...
										<div class="carousel-inner">
											<div class="carousel-item active">
												<div class="card border-0 text-center">
													...
													<div class="card-body">
														<p>
															Lorem ipsum dolor sit amet consectetur adipisicing elit sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor reprehenderit.in voluptate.velit esse cillum dolore eu fugiat.excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
														</p>
														<a class="text-dark pt-4 d-block text-center font-weight-medium font-size-15" href="#">Peter Kain</a>
