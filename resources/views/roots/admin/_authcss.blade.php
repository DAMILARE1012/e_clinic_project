<link rel="stylesheet" href="{{ asset('admin/libs/bower/font-awesome/css/font-awesome.min.css') }}">
	<link rel="stylesheet" href="{{ asset('admin/libs/bower/material-design-iconic-font/dist/css/material-design-iconic-font.min.css') }}">
	...
	<link rel="stylesheet" href="{{ asset('admin/assets/css/misc-pages.css') }}">
