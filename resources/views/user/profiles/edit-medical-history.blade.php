            ...
            <form action="{{ route('user.check.medical.checks') }}" method="post">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            <label for="exampleInputtext1">Had a Surgery? <i class="fa fa-exclamation-circle text-danger"></i></label>
                        ...
                        <div class="form-group">
                            <label for="exampleInputtext1">Blood type <i class="fa fa-exclamation-circle text-danger"></i></label>
                        ...
                        <div class="form-group">
                            <label for="exampleInputtext1">Drug History (regular routine medication) <i class="fa fa-exclamation-circle text-danger"></i></label>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            <label for="exampleInputtext1">Had Blood Transfusions? <i class="fa fa-exclamation-circle text-danger"></i></label>
                        ...
                        <div class="form-group">
                            <label for="exampleInputtext1">Donated Organ? <i class="fa fa-exclamation-circle text-danger"></i></label>
                        ...
                        <div class="form-group">
                            <label for="exampleInputtext1">Allergies & Reactions <i class="fa fa-exclamation-circle text-danger"></i></label>
                ...
                @if($profile->gender == 'Female')
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="exampleInputtext1">Last Menstrual Period <i class="fa fa-exclamation-circle text-danger"></i></label>
                            ...
                            <div class="form-group">
                                <label for="exampleInputtext1">Number of Deliveries <i class="fa fa-exclamation-circle text-danger"></i></label>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="exampleInputtext1">Number of Pregnancies <i class="fa fa-exclamation-circle text-danger"></i></label>
                            ...
                            <div class="form-group">
                                <label for="exampleInputtext1">Number of Children Alive <i class="fa fa-exclamation-circle text-danger"></i></label>
